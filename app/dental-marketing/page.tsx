    ...
    <>
      ...
      <div className="page-banner">
        <div className="container page-banner-inner">
          ...
          <h1 className="page-title">Attract patients who choose you &mdash; not just whoever takes their insurance.</h1>
          <p className="page-sub mkt-sub-desktop">Ekwa Marketing helps dental practices rank higher, convert more website visitors, and bring in the kind of patients who stay for years &mdash; not just whoever is in-network.</p>
          {/* MOBILE: instant book CTA in banner */}
          <div className="mkt-quick-book">
            <a href="#ycbmiframeekwasales-withoutceo-insuranceuntangled" className="cqb-btn" style={{ marginTop: "1rem", display: "inline-block", textDecoration: "none" }}>Book a Free Strategy Meeting &rarr;</a>
            <div className="cqb-sub" style={{ textAlign: "center", marginTop: ".5rem" }}>15 min &bull; Free &bull; No obligation</div>
          </div>
        </div>
      </div>

      {/* Two-pane below the hero */}
      <div className="two-pane-page">
        ...
        <div className="two-pane-left">
          <div>
            ...
            <div className="marketing-features-grid">
              <div className="mf-card reveal-d1"><div className="mf-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></svg></div><div className="mf-title">Local SEO &amp; Google Rankings</div><p className="mf-desc">Rank in the local top 5% on Google for the procedures and patient types you want most.</p></div>
              <div className="mf-card reveal-d2"><div className="mf-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="3" width="20" height="14" rx="2" /><line x1="8" y1="21" x2="16" y2="21" /><line x1="12" y1="17" x2="12" y2="21" /></svg></div><div className="mf-title">Website Conversion Optimisation</div><p className="mf-desc">Turn visitors into booked appointments through design, copy, and UX improvements.</p></div>
              <div className="mf-card reveal-d3"><div className="mf-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /></svg></div><div className="mf-title">New Patient Acquisition</div><p className="mf-desc">Attract patients who choose you for the quality of your care — not just your insurance network.</p></div>
              <div className="mf-card reveal-d4"><div className="mf-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12" /></svg></div><div className="mf-title">Monthly Strategy Reviews</div><p className="mf-desc">Dedicated account manager, detailed reporting, and regular strategy adjustments based on your data.</p></div>
              <div className="mf-card reveal-d5"><div className="mf-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg></div><div className="mf-title">Reputation Management</div><p className="mf-desc">Build and manage your online reviews to attract the right patients and outrank competitors.</p></div>
              <div className="mf-card"><div className="mf-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="9" y="9" width="13" height="13" rx="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg></div><div className="mf-title">Content &amp; Social Media</div><p className="mf-desc">Educational content that positions your practice as the trusted authority in your market.</p></div>
            </div>
          </div>
        </div>

        {/* RIGHT: Embedded scheduler (sticky) */}
        <div className="two-pane-right">
          <div className="scheduler-panel">
            <div className="scheduler-panel-header">
              ...
              <div className="booking-panel-sub">Pick a date and time that works for you. A strategist will review your practice before the call.</div>
            </div>
